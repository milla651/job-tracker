...
export function KanbanBoard({ initialJobs }: KanbanBoardProps) {
  ...
  // Define columns mapping with better descriptions for pipeline flow
  const columns: {
    id: string;
    title: string;
    status: JobStatus;
  ...
  return (
    <>
      ...
      <div
        ...
        <Button
          size="lg"
          className={`h-14 rounded-full shadow-xl flex items-center justify-center gap-2 px-6 transition-all ${
            isDragOverArchive
